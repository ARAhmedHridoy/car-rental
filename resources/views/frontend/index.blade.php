...
@section('content')
            ...
            <form action="{{ route('cars.filter') }}" method="GET">
                <div class="row">
                    <div class="col-xl-3 col-lg-4 col-md-6 px-2">
                        ...
                        <select class="custom-select px-4 mb-3" name="car_type" id="car_type" style="height: 50px;" placeholder="Pickup Date">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 px-2">
                        ...
                        <select class="custom-select px-4 mb-3" name="brand" id="brand" style="height: 50px;" placeholder="Pickup Date">
                            <option value="">All</option>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 px-2">
                        <div class="time mb-3" id="time" data-target-input="nearest">
                            ...
                            <input type="number" name="price_max" id="price_max" class="form-control p-4" value="{{ request('price_max') }}" min="0">
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6 px-2">
                        <label for="price_max" class="mr-2"></label>
                        <button class="btn btn-primary btn-block mb-3" type="submit" style="height: 50px; margin-top: 10px;">Search</button>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            ...
            <h1 class="display-4 text-uppercase text-center mb-5">Available Car</h1>
            <div class="row">
                @foreach($cars as $car)
                    <div class="col-lg-4 col-md-6 mb-2">
                        <div class="rent-item mb-4">
                            <img class="img-fluid mb-4" src="{{ asset('images/cars/' . $car->image) }}" alt="{{ $car->name }}">
                            ...
                            <a class="btn btn-primary px-3" href="{{ url('car-details/' . $car->id) }}">Book Now</a>
                        </div>
                    </div>
                @endforeach
            </div>
